                ...
                <div class="col-lg-12">
                    <div class="breadcrumb_iner text-center">
                        <div class="breadcrumb_iner_item">
                            <h2>Blog Single</h2>
                            <p class="breadcrumbs"><span class="mr-2"><a href="index.php">الرئيسية <i class="fa fa-chevron-left"></i></a></span> <span> الثالثة ثانوي<i class="fa fa-chevron-left"></i></span></p>
                        </div>
                    </div>
                </div>
            </div>
